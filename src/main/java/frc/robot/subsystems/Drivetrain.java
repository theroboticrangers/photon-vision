...
public class Drivetrain extends SubsystemBase {
	...
	public static final double FRONT_LEFT_VIRTUAL_OFFSET_RADIANS = -1.367; // adjust as needed so that virtual (turn) position of wheel is zero when straight
	public static final double FRONT_RIGHT_VIRTUAL_OFFSET_RADIANS = -1.782; // adjust as needed so that virtual (turn) position of wheel is zero when straight
	public static final double REAR_LEFT_VIRTUAL_OFFSET_RADIANS = 2.073; // adjust as needed so that virtual (turn) position of wheel is zero when straight
	public static final double REAR_RIGHT_VIRTUAL_OFFSET_RADIANS = -.605; // adjust as needed so that virtual (turn) position of wheel is zero when straight
